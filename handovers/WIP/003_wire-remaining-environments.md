...
**Done:**
- Firebase Hosting live at https://skills-hub.web.app/hub/
...
**Remaining:**
- Claude sandboxes (web/Desktop): configure environment setup scripts to run `curl -fsSL "https://skills-hub.web.app/hub/claude/skills.tar.gz" | tar -xz -C ~/.claude/skills` — this MUST be a setup script, NOT a SessionStart hook
- Claude CLI local: run `SKILLS_BASE_URL="https://skills-hub.web.app/hub" ./bootstrap/claude-setup.sh` or set up a local symlink from dist/
- Codex: confirm skills directory location, run `SKILLS_BASE_URL="https://skills-hub.web.app/hub" ./bootstrap/codex-setup.sh`
...
- Skills tarball verified accessible at https://skills-hub.web.app/hub/claude/skills.tar.gz (HTTP 200)
